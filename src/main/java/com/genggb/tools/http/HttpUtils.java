...
public class HttpUtils {
    ...
    public static void main(String[] args) throws JSONException {
        ...
        json.put("qssj","2015-08-24 18:00:00");
        json.put("jssj","2020-08-24 18:00:00");
        json.put("ajbh","130800000000304");
        json.put("pageNo",1);
        json.put("pageSize",100);
        String rtn = sendPost("http://192.168.1.158:8088/xszfweb/wsfy-api/api/v1/lf/wsjf", json.toString());
        log.info(rtn);
    }
...
//        entity.setContentType("application/json");
        HttpPost httpPost = new HttpPost(url);
        httpPost.setHeader("sid", "123");
        httpPost.setHeader("systemid", "123");
        httpPost.setHeader("authcode", "123");
